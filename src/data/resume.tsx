...
avatarUrl: "/me.png",
  ...
  work: [
    {
      company: "Traub Capital Management",
      href: "https://www.traubcapital.com/",
      badges: [],
      location: "Needham, MA",
      ...
      description:
        "● Improved stock selection with quantitative models, enhancing investment decisions. \n● Boosted portfolio performance with better risk-adjusted returns using Sharpe ratio and standard deviation.\n● Optimized client portfolios through strategic 401k reviews and vaious analysis techniques.",
    },
  ],
  education: [
    // {
